...
// //                     <div className="mt-16">
// //                         <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
// //                             <div className="scale-100 p-6 bg-white rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
// //                                 <div>
...
// //                                     <h2 className="mt-6 text-xl font-semibold text-gray-900">معرض السيارات</h2>

// //                                     <p className="mt-4 text-gray-500 text-sm leading-relaxed">
// //                                         تصفح أحدث السيارات المتاحة لدينا بجميع الموديلات والماركات العالمية
// //                                     </p>
// //                                 </div>
// //                             </div>
...
// //                                     <h2 className="mt-6 text-xl font-semibold text-gray-900">خدمات مميزة</h2>

// //                                     <p className="mt-4 text-gray-500 text-sm leading-relaxed">
// //                                         نقدم خدمات ما بعد البيع وضمانات مميزة لجميع عملائنا الكرام
// //                                     </p>
// //                                 </div>
// //                             </div>
...
// //                                     <h2 className="mt-6 text-xl font-semibold text-gray-900">تقييم العملاء</h2>

// //                                     <p className="mt-4 text-gray-500 text-sm leading-relaxed">
// //                                         انضم إلى آلاف العملاء الراضين عن خدماتنا وجودة سياراتنا
// //                                     </p>
// //                                 </div>
// //                             </div>
...
// //                                     <h2 className="mt-6 text-xl font-semibold text-gray-900">عروض خاصة</h2>

// //                                     <p className="mt-4 text-gray-500 text-sm leading-relaxed">
// //                                         استفد من العروض والخصومات الحصرية لعملائنا المسجلين
// //                                     </p>
// //                                 </div>
// //                             </div>
// //                         </div>
...
// //                             نظام إدارة السيارات | إصدار {laravelVersion} (PHP v{phpVersion})
// //                         </div>
// //                     </div>
// //                 </div>
// //             </div>
