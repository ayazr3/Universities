...
//                 استكشف مجموعة متنوعة من التخصصات الهندسية المتقدمة التي تؤهلك
//                 لسوق العمل
//             </p>
                    ...
                    specializations.map((item, idx) => (
                        ...
                        >
                            ...
                            <div>
                                ...
                                {/* الزر هنا يصبح رابط Inertia للانتقال لصفحة تفاصيل التخصص مع تمرير الآيدي */}
                                <Link
                                    href={`/specializations/${item.id}`}
                                    className={`card-btn${activeIndex === idx ? " show" : ""}`}
                                    tabIndex={activeIndex === idx ? 0 : -1}
                                    onClick={(e) => e.stopPropagation()} // منع تداخل الكليك مع أصل الكارد
                                >
                                    استكشف التخصص
                                </Link>
                            </div>
